...
#Loading data
data<-read.csv("Human Data/Processed Data/DGS Data L PROCESSED 20230420 1730.csv")

#Melt a dataframe for analyzing positive choices
posData<-melt(as.data.table(data),
               id.vars=c(1,3,6:10,49:58,67:70),
               measure.vars=59:63)

#Rename variable and value columns
colnames(posData)[22:23]<-c("trait","choice")
...
#Rename variable and value columns
colnames(negData)[22:23]<-c("domain","choice")
...
posData$country<-factor(posData$country,labels=c("U.S.","Poland"))
levels(posData$country)<-c("Poland","U.S.")
...
negData$country<-factor(negData$country,labels=c("U.S.","Poland"))
